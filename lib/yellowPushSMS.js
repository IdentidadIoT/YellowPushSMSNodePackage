...
module.exports = {
     ...
     */
    start: function(user, pass, accId) {
        this.username = user;
        this.password = pass; 
        ...
        var sendSMSPromise = new Promise((resolve, reject) => {
            ...
            if(this.accountId){
                getAuth(this.username, this.password)
                    .then(responseAuth => sendMessage(responseAuth.token, this.accountId, cellphoneNumbers, sender, message))
    ...
    bulkSendSMS: function(listMessages){
        ...
        var bulkSendSMSPromise = new Promise((resolve, reject) => {
            ...
            if(this.accountId){
                getAuth(this.username, this.password)
                    .then(responseAuth => bulkSMS(responseAuth.token, this.accountId, listMessages, true))
